        ...
        <div class="mt-6 grid items-start gap-6 lg:grid-cols-[260px_1fr]">
            ...
            <div>
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <a href="{{ route('cabinet.orders') }}" class="group rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
                        ...
                        <span class="mt-3 block text-2xl font-bold text-slate-900">{{ $ordersCount }}</span>
                        <span class="text-sm text-slate-500">заказов</span>

...
- Этап 3 — корзина покупателя (гостевая в сессии, для авторизованных в БД,
  ...
  неактивные, листание стрелками поверх крайних), страховка админки от
  «зависшей» кнопки «Загрузка файла...» при загрузке изображений.
...
Общий прогон `php artisan test` — **90 тестов, все зелёные** (не забыть

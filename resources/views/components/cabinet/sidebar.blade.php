    ...
    @if (auth()->user()?->isAdmin())
        <div class="mt-6 border-t border-slate-100 pt-4">
            <a
                ...
                class="flex items-center justify-center gap-2 rounded-md bg-brand-600 px-3 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-brand-700"
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="size-5">
